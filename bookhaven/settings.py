...
SECRET_KEY = 'django-insecure-^ld@3p$tdzxs0m87^09i1ak#x3jifri8+ap881zg6jbuyxtuse'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # This tells Django where to look for static files in development
]
...
ASGI_APPLICATION = 'bookhaven.asgi.application'
